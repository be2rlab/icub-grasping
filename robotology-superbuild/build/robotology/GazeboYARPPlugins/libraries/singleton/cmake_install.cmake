# Install script for directory: /icub-grasping/robotology-superbuild/robotology/GazeboYARPPlugins/libraries/singleton
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/icub-grasping/robotology-superbuild/build/robotology/GazeboYARPPlugins/libraries/singleton/libgazebo_yarp_singleton.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libgazebo_yarp_singleton.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libgazebo_yarp_singleton.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libgazebo_yarp_singleton.so"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/GazeboYarpPlugins" TYPE FILE FILES
    "/icub-grasping/robotology-superbuild/robotology/GazeboYARPPlugins/libraries/singleton/include/GazeboYarpPlugins/Handler.hh"
    "/icub-grasping/robotology-superbuild/robotology/GazeboYARPPlugins/libraries/singleton/include/GazeboYarpPlugins/ConfHelpers.hh"
    )
endif()
