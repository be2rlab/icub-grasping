...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_imuFilter(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<yarp::dev::ImuFilter>("imuFilter",
                "",
                "yarp::dev::ImuFilter");
...
YARP_DEFINE_SHARED_SUBCLASS(imuFilter, yarp::dev::ImuFilter, yarp::dev::DeviceDriver)
