...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_cartesiancontrollerclient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<ClientCartesianController>("cartesiancontrollerclient",
...
YARP_DEFINE_SHARED_SUBCLASS(cartesiancontrollerclient, ClientCartesianController, yarp::dev::DeviceDriver)
