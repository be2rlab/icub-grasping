...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_cartesiancontrollerserver(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<ServerCartesianController>("cartesiancontrollerserver",
...
YARP_DEFINE_SHARED_SUBCLASS(cartesiancontrollerserver, ServerCartesianController, yarp::dev::DeviceDriver)
