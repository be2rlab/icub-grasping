...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_gazecontrollerclient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<ClientGazeController>("gazecontrollerclient",
...
YARP_DEFINE_SHARED_SUBCLASS(gazecontrollerclient, ClientGazeController, yarp::dev::DeviceDriver)
