...
QT_MOC_LITERAL(3, 30, 19), // "on_btnApply_clicked"
QT_MOC_LITERAL(4, 50, 20), // "on_btnCancel_clicked"
QT_MOC_LITERAL(5, 71, 16) // "on_btnOk_clicked"

    },
    "SettingsDialog\0configChanged\0\0"
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsDialog::configChanged)) {
                *result = 0;
                return;
            }
        }
