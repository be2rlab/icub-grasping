...
#ifndef YARP_THRIFT_GENERATOR_SERVICE_DEPTH2KIN_IDL_H
#define YARP_THRIFT_GENERATOR_SERVICE_DEPTH2KIN_IDL_H
...
#endif // YARP_THRIFT_GENERATOR_SERVICE_DEPTH2KIN_IDL_H
