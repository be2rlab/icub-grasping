...
QT_MOC_LITERAL(1, 11, 11), // "portCreated"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 15) // "openErrorDialog"

    },
    "PortThread\0portCreated\0\0openErrorDialog"
};
...
void PortThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->portCreated(); break;
        case 1: _t->openErrorDialog((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (PortThread::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PortThread::portCreated)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (PortThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PortThread::openErrorDialog)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void PortThread::portCreated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void PortThread::openErrorDialog(QString _t1)
{
