...
#include "../../../../../../../../robotology/YARP/src/yarpscope/plugin/plotmanager.h"
...
QT_MOC_LITERAL(1, 12, 14), // "requestRepaint"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 15), // "plottersChanged"
QT_MOC_LITERAL(4, 44, 9) // "onTimeout"

    },
    "PlotManager\0requestRepaint\0\0plottersChanged\0"
    "onTimeout"
};
...
void PlotManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->plottersChanged(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlotManager::requestRepaint)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (PlotManager::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlotManager::plottersChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject PlotManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PlotManager.data,
