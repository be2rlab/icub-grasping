...
QT_MOC_LITERAL(1, 10, 15), // "updateGuiThread"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 5), // "pause"
QT_MOC_LITERAL(4, 33, 12) // "errorMessage"

    },
    "Utilities\0updateGuiThread\0\0pause\0"
    "errorMessage"
};
...
void Utilities::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateGuiThread(); break;
        ...
        {
            typedef void (Utilities::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Utilities::updateGuiThread)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Utilities::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Utilities::pause)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Utilities::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Utilities::errorMessage)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject Utilities::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Utilities.data,
      qt_meta_data_Utilities,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Utilities::updateGuiThread()
{
...
// SIGNAL 2
void Utilities::errorMessage(QString _t1)
{
