...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_bayer(const char *owner) {
    yarp::os::Carriers::addCarrierPrototype(new BayerCarrier);
}
#endif

YARP_DEFINE_SHARED_SUBCLASS(bayer, BayerCarrier, yarp::os::Carrier)
