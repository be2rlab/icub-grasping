...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_priority(const char *owner) {
    yarp::os::Carriers::addCarrierPrototype(new PriorityCarrier);
}
#endif

YARP_DEFINE_SHARED_SUBCLASS(priority, PriorityCarrier, yarp::os::Carrier)
