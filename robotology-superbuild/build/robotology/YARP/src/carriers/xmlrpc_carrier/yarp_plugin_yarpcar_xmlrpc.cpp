...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_xmlrpc(const char *owner) {
    yarp::os::Carriers::addCarrierPrototype(new XmlRpcCarrier);
}
#endif

YARP_DEFINE_SHARED_SUBCLASS(xmlrpc, XmlRpcCarrier, yarp::os::Carrier)
