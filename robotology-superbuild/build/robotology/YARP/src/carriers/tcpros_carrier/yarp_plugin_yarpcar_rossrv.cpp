...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_rossrv(const char *owner) {
    yarp::os::Carriers::addCarrierPrototype(new RosSrvCarrier);
}
#endif

YARP_DEFINE_SHARED_SUBCLASS(rossrv, RosSrvCarrier, yarp::os::Carrier)
