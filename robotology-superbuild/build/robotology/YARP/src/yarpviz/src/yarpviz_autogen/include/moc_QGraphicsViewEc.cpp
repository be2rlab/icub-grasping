...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGraphicsViewEc_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGraphicsViewEc_t qt_meta_stringdata_QGraphicsViewEc = {
    {
QT_MOC_LITERAL(0, 0, 15) // "QGraphicsViewEc"
...
const QMetaObject QGraphicsViewEc::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_QGraphicsViewEc.data,
      qt_meta_data_QGraphicsViewEc,  qt_static_metacall, nullptr, nullptr}
};
