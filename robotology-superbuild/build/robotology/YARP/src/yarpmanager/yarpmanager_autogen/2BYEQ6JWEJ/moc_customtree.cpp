...
#include "src-builder/customtree.h"
...
struct qt_meta_stringdata_CustomTree_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CustomTree_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CustomTree_t qt_meta_stringdata_CustomTree = {
    {
QT_MOC_LITERAL(0, 0, 10) // "CustomTree"
...
const QMetaObject CustomTree::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_CustomTree.data,
      qt_meta_data_CustomTree,  qt_static_metacall, nullptr, nullptr}
};
...
void *CustomTree::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomTree.stringdata0))
