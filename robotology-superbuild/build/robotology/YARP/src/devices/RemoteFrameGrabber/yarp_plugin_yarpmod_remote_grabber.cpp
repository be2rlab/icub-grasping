...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_remote_grabber(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<RemoteFrameGrabber>("remote_grabber",
                "grabber",
                "RemoteFrameGrabber");
...
YARP_DEFINE_SHARED_SUBCLASS(remote_grabber, RemoteFrameGrabber, yarp::dev::DeviceDriver)
