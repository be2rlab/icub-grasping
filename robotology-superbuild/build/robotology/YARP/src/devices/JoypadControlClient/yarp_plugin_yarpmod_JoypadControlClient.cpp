...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_JoypadControlClient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<JoypadControlClient>("JoypadControlClient",
                "JoypadControlClient",
                "JoypadControlClient");
...
YARP_DEFINE_SHARED_SUBCLASS(JoypadControlClient, JoypadControlClient, yarp::dev::DeviceDriver)
