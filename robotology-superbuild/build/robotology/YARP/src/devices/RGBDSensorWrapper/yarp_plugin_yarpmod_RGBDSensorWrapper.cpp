...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_RGBDSensorWrapper(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<RGBDSensorWrapper>("RGBDSensorWrapper",
                "RGBDSensorWrapper",
                "RGBDSensorWrapper");
...
YARP_DEFINE_SHARED_SUBCLASS(RGBDSensorWrapper, RGBDSensorWrapper, yarp::dev::DeviceDriver)
