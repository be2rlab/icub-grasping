...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_JoypadControlServer(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<JoypadControlServer>("JoypadControlServer",
                "JoypadControlServer",
                "JoypadControlServer");
...
YARP_DEFINE_SHARED_SUBCLASS(JoypadControlServer, JoypadControlServer, yarp::dev::DeviceDriver)
