...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_map2DServer(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<Map2DServer>("map2DServer",
                "",
                "Map2DServer");
...
YARP_DEFINE_SHARED_SUBCLASS(map2DServer, Map2DServer, yarp::dev::DeviceDriver)
