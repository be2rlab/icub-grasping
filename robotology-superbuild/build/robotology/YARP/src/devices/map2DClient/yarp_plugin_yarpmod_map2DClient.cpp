...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_map2DClient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<Map2DClient>("map2DClient",
                "",
                "Map2DClient");
...
YARP_DEFINE_SHARED_SUBCLASS(map2DClient, Map2DClient, yarp::dev::DeviceDriver)
