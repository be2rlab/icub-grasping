...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_localization2DClient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<Localization2DClient>("localization2DClient",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(localization2DClient, Localization2DClient, yarp::dev::DeviceDriver)
