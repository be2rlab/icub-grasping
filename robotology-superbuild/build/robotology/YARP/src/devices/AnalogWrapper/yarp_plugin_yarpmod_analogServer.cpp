...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_analogServer(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<AnalogWrapper>("analogServer",
                "analogServer",
                "AnalogWrapper");
...
YARP_DEFINE_SHARED_SUBCLASS(analogServer, AnalogWrapper, yarp::dev::DeviceDriver)
