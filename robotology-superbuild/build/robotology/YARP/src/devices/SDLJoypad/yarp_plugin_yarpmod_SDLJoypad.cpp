...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_SDLJoypad(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<SDLJoypad>("SDLJoypad",
                "JoypadControlServer",
                "SDLJoypad");
...
YARP_DEFINE_SHARED_SUBCLASS(SDLJoypad, SDLJoypad, yarp::dev::DeviceDriver)
