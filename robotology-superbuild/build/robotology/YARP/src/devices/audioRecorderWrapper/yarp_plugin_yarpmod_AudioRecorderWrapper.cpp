...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_AudioRecorderWrapper(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<AudioRecorderWrapper>("AudioRecorderWrapper",
...
YARP_DEFINE_SHARED_SUBCLASS(AudioRecorderWrapper, AudioRecorderWrapper, yarp::dev::DeviceDriver)
