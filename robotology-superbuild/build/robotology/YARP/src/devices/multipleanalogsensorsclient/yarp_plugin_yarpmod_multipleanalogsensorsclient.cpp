...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_multipleanalogsensorsclient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<MultipleAnalogSensorsClient>("multipleanalogsensorsclient",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(multipleanalogsensorsclient, MultipleAnalogSensorsClient, yarp::dev::DeviceDriver)
