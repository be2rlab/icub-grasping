...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_RGBDSensorClient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<RGBDSensorClient>("RGBDSensorClient",
                "RGBDSensorClient",
                "RGBDSensorClient");
...
YARP_DEFINE_SHARED_SUBCLASS(RGBDSensorClient, RGBDSensorClient, yarp::dev::DeviceDriver)
