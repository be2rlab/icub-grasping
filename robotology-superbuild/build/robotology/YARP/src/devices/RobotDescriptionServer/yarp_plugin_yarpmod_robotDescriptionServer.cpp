...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_robotDescriptionServer(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<RobotDescriptionServer>("robotDescriptionServer",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(robotDescriptionServer, RobotDescriptionServer, yarp::dev::DeviceDriver)
