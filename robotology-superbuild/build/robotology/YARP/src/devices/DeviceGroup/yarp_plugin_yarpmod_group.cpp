...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_group(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<DeviceGroup>("group",
                "",
                "DeviceGroup");
...
YARP_DEFINE_SHARED_SUBCLASS(group, DeviceGroup, yarp::dev::DeviceDriver)
