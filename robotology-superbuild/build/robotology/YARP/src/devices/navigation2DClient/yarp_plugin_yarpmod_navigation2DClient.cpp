...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_navigation2DClient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<Navigation2DClient>("navigation2DClient",
                "",
                "Navigation2DClient");
...
YARP_DEFINE_SHARED_SUBCLASS(navigation2DClient, Navigation2DClient, yarp::dev::DeviceDriver)
