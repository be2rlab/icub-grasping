...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_pipe(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<DevicePipe>("pipe",
                "",
                "DevicePipe");
...
YARP_DEFINE_SHARED_SUBCLASS(pipe, DevicePipe, yarp::dev::DeviceDriver)
