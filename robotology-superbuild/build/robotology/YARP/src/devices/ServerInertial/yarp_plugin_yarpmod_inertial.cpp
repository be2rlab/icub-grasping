...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_inertial(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<ServerInertial>("inertial",
                "inertial",
                "ServerInertial");
...
YARP_DEFINE_SHARED_SUBCLASS(inertial, ServerInertial, yarp::dev::DeviceDriver)
