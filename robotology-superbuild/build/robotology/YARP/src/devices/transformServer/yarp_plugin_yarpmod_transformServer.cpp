...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_transformServer(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<FrameTransformServer>("transformServer",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(transformServer, FrameTransformServer, yarp::dev::DeviceDriver)
