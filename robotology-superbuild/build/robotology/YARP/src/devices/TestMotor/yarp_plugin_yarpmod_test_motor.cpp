...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_test_motor(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<TestMotor>("test_motor",
                "controlboard",
                "TestMotor");
...
YARP_DEFINE_SHARED_SUBCLASS(test_motor, TestMotor, yarp::dev::DeviceDriver)
