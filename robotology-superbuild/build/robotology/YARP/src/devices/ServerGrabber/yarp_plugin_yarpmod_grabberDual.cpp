...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_grabberDual(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<ServerGrabber>("grabberDual",
                "grabberDual",
                "ServerGrabber");
...
YARP_DEFINE_SHARED_SUBCLASS(grabberDual, ServerGrabber, yarp::dev::DeviceDriver)
