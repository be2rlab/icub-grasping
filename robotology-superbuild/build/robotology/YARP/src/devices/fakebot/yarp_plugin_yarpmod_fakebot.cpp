...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_fakebot(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<FakeBot>("fakebot",
                "",
                "FakeBot");
...
YARP_DEFINE_SHARED_SUBCLASS(fakebot, FakeBot, yarp::dev::DeviceDriver)
