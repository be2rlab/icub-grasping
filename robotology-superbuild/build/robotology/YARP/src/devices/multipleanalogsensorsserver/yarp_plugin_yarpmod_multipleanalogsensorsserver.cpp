...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_multipleanalogsensorsserver(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<MultipleAnalogSensorsServer>("multipleanalogsensorsserver",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(multipleanalogsensorsserver, MultipleAnalogSensorsServer, yarp::dev::DeviceDriver)
