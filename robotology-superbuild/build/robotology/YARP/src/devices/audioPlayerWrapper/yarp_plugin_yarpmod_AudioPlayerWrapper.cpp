...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_AudioPlayerWrapper(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<AudioPlayerWrapper>("AudioPlayerWrapper",
                "AudioPlayerWrapper",
                "AudioPlayerWrapper");
...
YARP_DEFINE_SHARED_SUBCLASS(AudioPlayerWrapper, AudioPlayerWrapper, yarp::dev::DeviceDriver)
