...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_batteryClient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<BatteryClient>("batteryClient",
                "",
                "BatteryClient");
...
YARP_DEFINE_SHARED_SUBCLASS(batteryClient, BatteryClient, yarp::dev::DeviceDriver)
