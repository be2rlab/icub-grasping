...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_analogsensorclient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<AnalogSensorClient>("analogsensorclient",
                "",
                "AnalogSensorClient");
...
YARP_DEFINE_SHARED_SUBCLASS(analogsensorclient, AnalogSensorClient, yarp::dev::DeviceDriver)
