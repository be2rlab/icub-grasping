...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_Rangefinder2DClient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<Rangefinder2DClient>("Rangefinder2DClient",
                "",
                "Rangefinder2DClient");
...
YARP_DEFINE_SHARED_SUBCLASS(Rangefinder2DClient, Rangefinder2DClient, yarp::dev::DeviceDriver)
