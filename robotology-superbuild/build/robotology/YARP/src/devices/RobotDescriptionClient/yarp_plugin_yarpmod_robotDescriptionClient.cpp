...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_robotDescriptionClient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<RobotDescriptionClient>("robotDescriptionClient",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(robotDescriptionClient, RobotDescriptionClient, yarp::dev::DeviceDriver)
