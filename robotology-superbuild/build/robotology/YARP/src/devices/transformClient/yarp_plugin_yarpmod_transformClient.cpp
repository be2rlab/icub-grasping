...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_transformClient(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<FrameTransformClient>("transformClient",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(transformClient, FrameTransformClient, yarp::dev::DeviceDriver)
