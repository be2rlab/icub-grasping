...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_test_grabber(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<TestFrameGrabber>("test_grabber",
                "grabberDual",
                "TestFrameGrabber");
...
YARP_DEFINE_SHARED_SUBCLASS(test_grabber, TestFrameGrabber, yarp::dev::DeviceDriver)
