...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_Rangefinder2DWrapper(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<Rangefinder2DWrapper>("Rangefinder2DWrapper",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(Rangefinder2DWrapper, Rangefinder2DWrapper, yarp::dev::DeviceDriver)
