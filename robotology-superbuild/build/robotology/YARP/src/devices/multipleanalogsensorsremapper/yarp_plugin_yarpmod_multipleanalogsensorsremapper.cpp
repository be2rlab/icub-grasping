...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_multipleanalogsensorsremapper(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<MultipleAnalogSensorsRemapper>("multipleanalogsensorsremapper",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(multipleanalogsensorsremapper, MultipleAnalogSensorsRemapper, yarp::dev::DeviceDriver)
