...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_navigation2DServer(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<navigation2DServer>("navigation2DServer",
                "",
                "navigation2DServer");
...
YARP_DEFINE_SHARED_SUBCLASS(navigation2DServer, navigation2DServer, yarp::dev::DeviceDriver)
