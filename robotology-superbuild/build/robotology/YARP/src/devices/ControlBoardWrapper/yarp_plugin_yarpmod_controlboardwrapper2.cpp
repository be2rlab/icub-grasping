...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_controlboardwrapper2(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<ControlBoardWrapper>("controlboardwrapper2",
...
YARP_DEFINE_SHARED_SUBCLASS(controlboardwrapper2, ControlBoardWrapper, yarp::dev::DeviceDriver)
