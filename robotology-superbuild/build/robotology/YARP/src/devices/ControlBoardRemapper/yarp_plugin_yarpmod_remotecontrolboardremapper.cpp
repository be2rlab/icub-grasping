...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_remotecontrolboardremapper(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<RemoteControlBoardRemapper>("remotecontrolboardremapper",
...
YARP_DEFINE_SHARED_SUBCLASS(remotecontrolboardremapper, RemoteControlBoardRemapper, yarp::dev::DeviceDriver)
