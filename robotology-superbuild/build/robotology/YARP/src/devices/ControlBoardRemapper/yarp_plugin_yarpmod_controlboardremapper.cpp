...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_controlboardremapper(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<ControlBoardRemapper>("controlboardremapper",
...
YARP_DEFINE_SHARED_SUBCLASS(controlboardremapper, ControlBoardRemapper, yarp::dev::DeviceDriver)
