...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_serial(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<ServerSerial>("serial",
                "serial",
                "ServerSerial");
...
YARP_DEFINE_SHARED_SUBCLASS(serial, ServerSerial, yarp::dev::DeviceDriver)
