...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_batteryWrapper(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<BatteryWrapper>("batteryWrapper",
                "batteryWrapper",
                "BatteryWrapper");
...
YARP_DEFINE_SHARED_SUBCLASS(batteryWrapper, BatteryWrapper, yarp::dev::DeviceDriver)
