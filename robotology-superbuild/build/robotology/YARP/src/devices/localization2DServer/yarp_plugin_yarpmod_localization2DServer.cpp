...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_localization2DServer(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<Localization2DServer>("localization2DServer",
                "",
...
YARP_DEFINE_SHARED_SUBCLASS(localization2DServer, Localization2DServer, yarp::dev::DeviceDriver)
