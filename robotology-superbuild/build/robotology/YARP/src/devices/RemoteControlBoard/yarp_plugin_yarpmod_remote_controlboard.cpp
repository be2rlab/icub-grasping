...
#ifdef YARP_STATIC_PLUGIN
YARP_PLUGIN_EXPORT void add_owned_remote_controlboard(const char *owner) {
    yarp::dev::DriverCreator *factory =
        new yarp::dev::DriverCreatorOf<RemoteControlBoard>("remote_controlboard",
...
YARP_DEFINE_SHARED_SUBCLASS(remote_controlboard, RemoteControlBoard, yarp::dev::DeviceDriver)
