...
execute_process(
  COMMAND "/usr/bin/git" show-ref yarp-3.3
  WORKING_DIRECTORY "/icub-grasping/robotology-superbuild/robotology/YARP"
...
if("${show_ref_output}" MATCHES "refs/remotes/yarp-3.3")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "yarp-3.3")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "yarp-3.3")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 yarp-3.3
  WORKING_DIRECTORY "/icub-grasping/robotology-superbuild/robotology/YARP"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/robotology/yarp.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/icub-grasping/robotology-superbuild/robotology/YARP/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/icub-grasping/robotology-superbuild/robotology/YARP/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout yarp-3.3
      WORKING_DIRECTORY "/icub-grasping/robotology-superbuild/robotology/YARP"
      RESULT_VARIABLE error_code
      )
    if(error_code)
