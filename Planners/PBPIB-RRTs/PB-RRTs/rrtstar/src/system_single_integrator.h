...
namespace SingleIntegrator {
	...
	int RGDi(State &rstout);
	int RGDg(State &rstout);
	...
	int sampleState_i_to_g (State &randomStateOut, int t, int current_cycle);
        int sampleState_g_to_i (State &randomStateOut, int t, int current_cycle);
        /*!
