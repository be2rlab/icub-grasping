...
int main () {
    ...
    system.regionOperating.center[0] = ;
    system.regionOperating.center[1] = ;
    system.regionOperating.center[2] = ;
    system.regionOperating.size[0] = ;
    system.regionOperating.size[1] = ;
    system.regionOperating.size[2] = ;//50
    
    
    // Define the goal region 
    system.regionGoal.setNumDimensions(3);//,  
    system.regionGoal.center[0] = ;
    system.regionGoal.center[1] = ;
    system.regionGoal.center[2] = ;
    system.regionGoal.size[0] = ;
    system.regionGoal.size[1] = ;
    system.regionGoal.size[2] = ;

    system.regionGoal2.setNumDimensions(3);
    system.regionGoal2.center[0] = ;
    system.regionGoal2.center[1] = ;
    system.regionGoal2.center[1] = ;
    system.regionGoal2.size[0] = ;
    system.regionGoal2.size[1] = ;
    system.regionGoal2.size[1] = ;
  ...
  obstacle = new region;
   ...
   //  system.regionOperating, system.regionGoal,system.obstacles
  ...
  // Number of re takes
   ...
   {   
    ...
    int rewiring_per_iter = 0;
    float total_rewiring = 0;
    float rewiring_average = 0;
    float counter = 0;
   
    for (int i = 0; i < 5000000; i++) {
      
	  rrts.iteration (i,rewiring_per_iter, current_cycle); 
	  total_rewiring = total_rewiring + rewiring_per_iter;
	  counter = counter + 1;
		if ( ) {
			...
			rewiring_average = total_rewiring/counter;
			cout << "****************************   ReTake No " << current_cycle << "  ***********" << endl;
			myfile << "****************************   ReTake No " << current_cycle << "  ***********" << endl;

			cout << "Found best vertex in " << i << " iterations" << endl;
			myfile << "Found best vertex in " << i << " iterations" << endl;

			cout << "Total Rewiring =  " << total_rewiring << " times " << endl;
			myfile << "Total Rewiring =  " << total_rewiring << " times " << endl;
	
			cout << "Rewiring per iteration =  " << rewiring_average << " per iteration " << endl;
			myfile << "Rewiring per iteration =  " << rewiring_average << " per iteration " << endl;
    ...
    myfile << "Time : " << ((double)(finish-start))/CLOCKS_PER_SEC << endl;	     

    double cost = 0;
    double zCost1= rrts.getBestVertexCost();
    double zCost2= rrts.getBestVertexCost2();
    double zCost3= rrts.getBestVertexCostAB();
    
    if(zCost3<zCost1 && zCost3<zCost2)
    {
        cost = zCost3;
    }
    else if(zCost2<zCost1 && zCost2<zCost3)
    {
        cost = zCost2; 
    }
    else if(zCost1<zCost2 && zCost1<zCost3)
    {
       cost = zCost1; 
    }
    
    cout << "Total Cost of Path C = " << cost << endl;	
    myfile << "Total Cost of Path C = " << cost << endl;
    ...
    myfile << " ******************************* END OF ITERATION ******************** " << endl << endl ;
