...
class Trian:
    ...
    def coor(self, label, imgL, imgR, ori, x_pos_L, y_pos_L, x_pos_R, y_pos_R ):      
        classificator = Vision()    
        
        label_1, cL = classificator.process_frame(imgL)
        label_1, cR = classificator.process_frame(imgR)
