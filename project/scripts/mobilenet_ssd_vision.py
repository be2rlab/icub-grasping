...
class Vision:
    ...
    def process_frame(self, frame):
        ...
        return label, (xLeftBottom, yLeftBottom, xRightTop, yRightTop, lab)
...
class Trian:
    ...
    def coor(self, label, imgL, imgR, ori=1, x_pos_L=1, y_pos_L=1, x_pos_R=1, y_pos_R=1):
        ...
        label_1, cL = self._classificator.process_frame(imgL)
        label_1, cR = self._classificator.process_frame(imgR)

        x1, y1, z1 = -0.1, 0.1, -0.3
        #if cL[4] == label:
        if label_1 == label:
            # print('--------------------')
            # print(cL, cR)
            ...
            if gamma < 0.000001:    # simple zero division protection
                gamma = 0.000001
